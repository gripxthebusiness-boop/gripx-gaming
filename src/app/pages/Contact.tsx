        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800">+91 99238 69222 (Main)</p>
                    <p className="text-gray-800">+91 90630 32312</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800">support@neosell.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800">Palghar, India</p>
                  </div>
                </div>
              </div>

              <div className="bg-gradient-to-br from-white to-white border border-red-600/30 rounded-xl p-6">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="bg-gradient-to-br from-white to-white border border-red-600/30 rounded-xl p-8"
            >
